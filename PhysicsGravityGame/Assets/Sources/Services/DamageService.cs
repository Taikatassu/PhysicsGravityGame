...
public static class DamageService {
    ...
    public static void DealDamageOnCollision(GameEntity collidingEntity1, GameEntity collidingEntity2) {
        ...
        if (collidingEntity1.hasHealth)
            collidingEntity1.ReplaceHealth(collidingEntity1.health.value - 1);

        if (collidingEntity2.hasHealth)
            collidingEntity2.ReplaceHealth(collidingEntity2.health.value - 1);

        #region Calculate physics based damage
